...
view: +orderline {
  ...
  dimension: is_buying_price_defined {
    ...
    description: "Yes, if a sold items could be related to a weighted average cost price from our ERP system."
  ...
  dimension: amt_net_income_net_eur {
    ...
    description: "The net revenue through product sales. This field is only calculated for transactions, that also have a Weighted Average Cost (WAC) associated."
    group_label: "> Monetary Metrics (P&L)"
    type: number
