...
# ~~~~~~~~~~~~~~~     Daily Aggregation     ~~~~~~~~~~~~~~~~~~
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
explore: daily_historical_stock_levels {
  group_label: "16) Retail Test"

  always_filter: {
    filters: [
      daily_historical_stock_levels.tracking_date: "2 days"
    ]
  }
  ...
  join: hubs {
    ...
    sql_on: ${hubs.hub_code_lowercase} = ${daily_historical_stock_levels.hub_code} ;;
  }
  join: product_productvariant {
    sql_on: ${daily_historical_stock_levels.country_iso} = ${product_productvariant.country_iso} AND
      ${daily_historical_stock_levels.sku} = ${product_productvariant.sku} ;;
