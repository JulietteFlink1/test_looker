view: voucher_api_failure_success {
 ...
 ;;
  ...
  measure: cnt_success {
    label: "Count of successful Cart Discount application"
    description: "Number of Cart Discount successfully applied"
    type: sum
    sql: if(${event_type}="Success",1,0) ;;
  }

  measure: cnt_fail {
    label: "Count of failed Cart Discount application"
    description: "Number of failures to apply Cart Discount"
    type: sum
  ...
  measure: cnt_unique_anonymousid {
    label: "# Unique Users"
    description: "Number of Unique Users identified via Anonymous ID from Segment attempted Cart Discount application"
    hidden:  no
    type: count_distinct
    sql: ${anonymous_id};;
  ...
  measure: cnt_unique_anonymousid_success {
    ...
    description: "Number of Unique Users identified via Anonymous ID from Segment with successful Cart Discount application"
    hidden:  no
    type: count_distinct
    sql: ${anonymous_id};;
  ...
  measure: cnt_unique_anonymousid_fail{
    ...
    description: "Number of Unique Users identified via Anonymous ID from Segment with failed Cart Discount application"
    hidden:  no
    type: count_distinct
    sql: ${anonymous_id};;
  ...
  measure: perc_unique_voucher_fail_to_attempt {
    type: number
    description: "% Unique Users with failed Cart Discount application compared to total"
  ...
  measure: perc_absolute_voucher_fail_to_attempt {
    type: number
    description: "% absolute failed Cart Discount applications compared to total"
