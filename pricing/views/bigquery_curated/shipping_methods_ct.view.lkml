...
# ====================      Dates & Timestamps      ====================
  ...
  dimension_group: created_at_timestamp {
    ...
    label: "Created at"
    description: "Date and time (UTC) the ShippingMethod was initially created in CommerceTools."
  ...
  dimension_group: last_modified_at_timestamp {
    ...
    description: "Date and time (UTC) the ShippingMethod was last updated in CommerceTools."
    group_label: "Dates & Timestamps"
...
# ====================      IDs      ====================
  ...
  dimension: zone_id {
    ...
    label: "Zone ID"
    description: "Unique ID of the shipping fee zone, generated by the backend."
    group_label: "IDs"
...
# ====================      Delivery Fees & Thresholds      ====================
  ...
  dimension: amt_delivery_fee_gross {
    ...
    description: "Cost of the delivery fee for user's order."
    group_label: "Delivery Fees & Thresholds"
