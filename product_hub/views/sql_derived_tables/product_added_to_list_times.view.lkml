...
view: product_added_to_list {
  ...
  measure: sum_time_to_add_to_list_sec {
    ...
    group_label: "Times affected by switching"
    description: "Sum time_to_add_to_list time in seconds. This time is calculated only taking into account the inbound_progressed event, this means that this time is affected by switching flows."
    type: sum_distinct
    value_format: "0"
  ...
  measure: avg_time_to_add_to_cart_sec {
    ...
    group_label: "Times affected by switching"
    description: "Avg time_to_add_to_list time in seconds. This time is calculated only taking into account the inbound_progressed event, this means that this time is affected by switching flows."
