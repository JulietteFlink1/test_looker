...
# =========  Event Dimensions   =========
  ...
  dimension: container_ids {
    group_label: "Event Container Assigned"
    type: string
    description: "An array that contains the ean/ eans of the sku."
    sql: ${TABLE}.container_ids ;;
  }

  dimension: type {
    group_label: "Event Container Assigned"
    type: string
    description: "The type of container scanned, can be Container of Shelf."
    sql: ${TABLE}.type ;;
  }

  # dimension: method {
  #group_label: "Event Container Assigned"
  #   description: "The used method to assigned the container. It can be scanned or manual."
  #   type: string
  #   sql: ${TABLE}.method ;;
  # }
