view: event_bbd_date_correction_started {
  sql_table_name: `flink-data-prod.curated.event_bbd_date_correction_started`
    ;;
  view_label: "BBD Date Correction Started/ Finished"

  # This is the curated table for BBD Date Correction Started event coming from Hub One
