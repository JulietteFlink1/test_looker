view: event_stock_check_started {
  sql_table_name: `flink-data-prod.curated.event_stock_check_started`
    ;;
  view_label: "Stock Check Started/ Finished"

  # This is the curated table for Stock Check Started event coming from Hub One
