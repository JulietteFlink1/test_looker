view: event_logout_completed {
  sql_table_name: `flink-data-prod.curated.event_logout_completed`
    ;;
  view_label: "Event: Login/Logout Completed"

  # This is the curated table for Logout Completed event coming from Hub One
...
# =========  Location Attributes   =========
  ...
  dimension: type {
    type: string
    label: "Logout Type"
    group_label: "Logout Completed Dimensions"
    description: "The type of logout completed. It can be hub or staff logout."
    sql: ${TABLE}.type ;;
  }
  ...
  dimension: method {
    type: string
    group_label: "Logout Completed Dimensions"
    description: "  The method of the logout. It can be manual or automatic."
    sql: ${TABLE}.method ;;
  }
