...
# - Questions around inbounding flow in hub one

include: "/**/global_filters_and_parameters.view.lkml"
include: "/**/hubs_ct.view.lkml"
include: "/**/hub_one_inbounding_aggregates.view.lkml"

explore: hub_one_inbounding_aggregates {
  from:  hub_one_inbounding_aggregates
  view_name: hub_one_inbounding_aggregates
  hidden: no
  ...
  access_filter: {
    field: hub_one_inbounding_aggregates.country_iso
