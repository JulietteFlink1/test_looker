...
explore: stock_management_movement_ids {
  ...
  sql_always_where:{% condition global_filters_and_parameters.datasource_filter %} stock_management_movement_ids.date {% endcondition %}
    and {% condition global_filters_and_parameters.datasource_filter %} stock_management_movement_ids.date {% endcondition %};;
