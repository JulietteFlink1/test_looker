...
view: top_50_skus_per_gmv_inventory_daily_explore {
  view_label: "* Top 50 by GMV (last 14d) *"

  derived_table: {
    explore_source: inventory_stock_count_daily {

      column: country_iso              { field: hubs.country_iso }
      column: sku                      { field: orderline.product_sku }
      column: name                     { field: products.product_name }

      column: sum_item_price_gross_14d { field: orderline.sum_item_price_gross_14d }
