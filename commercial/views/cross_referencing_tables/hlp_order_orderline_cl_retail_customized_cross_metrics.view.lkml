view: hlp_order_orderline_cl_retail_customized_cross_metrics {
  ...
  measure: sum_number_of_orders_dynamic {
    ...
    {% if orders_cl.date_granularity._parameter_value == 'Day' %}
      ${ndt_orders_cl_metrics_per_country_and_order_date.sum_number_of_orders}
  ...
  measure: sum_number_of_unique_customers_dynamic {
    ...
    label: "# Unique Customers (per order-day/week/month & country)"
    ...
    sql:
        {% if orders_cl.date_granularity._parameter_value == 'Day' %}
        ${ndt_orders_cl_metrics_per_country_and_order_date.sum_number_of_unique_customers}
        {% elsif orders_cl.date_granularity._parameter_value == 'Week' %}
  ...
  measure: eur_gross_profit_dynamic_per_customer {
    ...
    label: "€ Gross Proft per Order (dynamic)"
  ...
  measure: eur_gross_profit_dynamic_per_order {
    ...
    label: "€ Gross Proft per Customer (dynamic)"
