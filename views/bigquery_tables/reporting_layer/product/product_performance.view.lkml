...
########### DIMENSIONS ###########
  ...
  dimension: is_product_purchased {
    ...
    dimension: product_revenue {
      ...
      description: "Gross revenue generated by a product"
  ...
  measure: amt_product_revenue_gross {
    group_label: "Monetary Values"
    label: "Product Revenue (Gross)"
    description: "Sum of the product revenue gross (incl. VAT)"
    type: sum
    hidden: no
    sql: ${product_revenue} ;;
    value_format_name: euro_accounting_2_precision
  ...
  measure: avg_product_revenue_gross {
    group_label: "Monetary Values"
    label: "AVG Product Revenue (Gross)"
    description: "Average product revenue gross (incl. VAT)"
    type: average
    hidden: no
    sql: ${product_revenue} ;;
    value_format_name: euro_accounting_2_precision
