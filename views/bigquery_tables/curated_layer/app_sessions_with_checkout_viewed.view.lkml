view: app_sessions_with_checkout_viewed {
  sql_table_name: `flink-data-dev.sandbox_natalia.app_sessions_with_checkout_viewed_v2`
    ;;

  view_label: "* App Sessions with Checkout Viewed*"
...
########### DIMENSIONS ###########
  ...
  dimension: is_session_with_checkout_started_v2 {
    group_label: "Generic Dimensions"
    description: "Session with started checkout from event model"
    type: yesno
    sql: ${TABLE}.is_session_with_checkout_started_v2 ;;
  }
...
#### Sessions with events ###
  ...
  measure: cnt_checkout_started_v2 {
    group_label: "Sessions with Event Flags"
    label: "# Sessions with Checkout Started from model"
    description: "Number of sessions in which at least one Checkout Started event happened"
    type: count
    filters: [is_session_with_checkout_started_v2: "yes"]
  }
  ...
  measure: mcvr3_v2 {
    group_label: "Conversions"
    label: "mCVR3 /checkoutViewed"
    type: number
    description: "#sessions in which there was a Checkout Viewed event happened, compared to the number of sessions in which there was a Product Added To Cart"
    value_format_name: percent_1
  ...
  measure: mcvr4_v2 {
    group_label: "Conversions"
    label: "mCVR4 /checkoutViewed"
    type: number
    description: "# sessions in which there was a Payment Started event happened, compared to the number of sessions in which there was a Checkout Viewed"
    value_format_name: percent_1
  ...
  set: detail {
    fields: [
      ...
      is_session_with_checkout_started_v2,
