  ...
  derived_table: {
    ...
    sql: WITH
        ...
        SELECT
          ...
          , tracks.event
          , tracks.event_text
          , tracks.context_traits_backend_search_enabled                  AS backend_search_enabled
          , tracks.context_traits_search_experiment_variant               AS search_experiment_variant
          , tracks.id
          , tracks.timestamp
        ...
        WHERE DATE(tracks._PARTITIONTIME) > "2021-10-10"
    ...
    , hub_data_union AS ( -- ios & android pulling address_confirmed and order_placed for hub_data and delivery_eta
        SELECT
              ...
              event.context_traits_backend_search_enabled,
              event.context_traits_search_experiment_variant,
    ...
    , has_address_fill AS (
      SELECT
        ...
        hd.hub_city,
        hd.hub_code,
        hd.context_traits_backend_search_enabled                  AS backend_search_enabled,
        hd.context_traits_search_experiment_variant               AS search_experiment_variant,
    ...
    SELECT  ha.event,
            ...
            ha.hub_country,
            ha.hub_code,
            ha.backend_search_enabled,
            ha.search_experiment_variant,
            ha.delivery_eta,
    ...
    FROM (
        SELECT
            ...
            , hd.backend_search_enabled
            , hd.search_experiment_variant
            , hd.hub_code
            , hd.hub_country
            , hd.hub_city
            , hd.delivery_eta
