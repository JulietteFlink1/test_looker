view: hiring_funnel_performance_summary_hub_level {
  sql_table_name: `flink-data-prod.reporting.hiring_funnel_performance_summary_hub_level`
    ;;
  ...
  dimension: unique_id {
    hidden: yes
    sql: concat(${country}, ${hub_code}, ${city}, ${channel}, ${position}, ${date_raw}) ;;
    primary_key: yes
  }
