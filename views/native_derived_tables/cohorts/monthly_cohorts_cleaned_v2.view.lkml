...
view: monthly_cohorts_cleaned_v2 {
  derived_table: {
    explore_source: orders_customers_cleaned_v2 {
      column: first_order_month { field: customers_metrics_cleaned_v2.first_order_month }
      ...
      column: months_time_since_sign_up { field: customers_metrics_cleaned_v2.months_time_since_sign_up }
      ...
      filters: {
        field: customers_metrics_cleaned_v2.months_time_since_sign_up
        value: "0"
      }
    }
  }
