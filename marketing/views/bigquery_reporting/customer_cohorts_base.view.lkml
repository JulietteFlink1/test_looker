view: customer_cohorts_base {
  sql_table_name: `flink-data-dev.dbt_jdavies_reporting.customer_cohorts_base`
    ;;
  ...
  dimension: first_order_discount_use_case {
    group_label: "* User Dimensions *"
    type: string
    description: "Discount use case associated with the discount code of the customer's first order. Discount use case is derived from discount name and group. Only populated for discount acquisitions."
    sql: ${TABLE}.first_order_discount_use_case ;;
  }
