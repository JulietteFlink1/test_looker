  ...
  measure: KPI {
    ...
    {% endif %};;
      ...
      measure: cnt_unique_customers_with_voucher {
        ...
        description: "Count of Unique Customers identified via their Email (only considering orders with a Cart Discount)"
        hidden:  no
        type: count_distinct
        sql: ${customer_id_mapped};;
      ...
      measure: cnt_unique_customers_without_voucher {
        ...
        description: "Count of Unique Customers identified via their Email (not considering orders with a Cart Discount)"
        hidden:  no
        type: count_distinct
        sql: ${customer_id_mapped};;
