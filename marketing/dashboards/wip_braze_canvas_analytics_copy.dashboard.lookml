- dashboard: wip_braze_canvas_analytics_copy
  title: "[WIP] Braze Canvas Analytics (copy)"
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: MlpWNnns0aL0x4gn5q9aOL
  elements:
  - title: Global Overview
    ...
    sorts: [braze_lifecycle_cohorts.canvas_variation_name]
    limit: 500
