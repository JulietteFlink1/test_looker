...
view: hub_uph_compliance {
  ...
  dimension: number_of_events_outside_shift {
    label: "# Events - Outside Shift"
    type: number
    hidden: yes
    description: "Number of Hub One events recorded outside the shift."
    sql: coalesce(${number_of_events_hub_one},0) - coalesce(${number_of_events_within_shift},0) ;;
  }
 ...
 ########## MEASURES ###########
  ...
  measure: sum_number_of_events_outside_shift {
    label: "# Events - Outside Shift"
    type: sum
    description: "Number of Hub One events recorded outside the shift."
    sql: ${number_of_events_outside_shift} ;;
  }

  measure: avg_number_of_events_outside_shift {
    label: "AVG # Events - Outside Shift"
    type: average
    description: "Average number of Hub One events recorded outside the shift."
    sql: ${number_of_events_outside_shift};;
  }
