...
join: daily_violations_aggregates {
  ...
  sql_on: ${daily_events.event_name_camel_case} = ${daily_violations_aggregates.violated_event_name} and ${daily_events.event_date}=${daily_violations_aggregates.event_date} and ${daily_events.platform}=${daily_violations_aggregates.platform} and ${daily_events.app_version}=${daily_violations_aggregates.app_version};;
  type: left_outer
