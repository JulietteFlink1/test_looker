...
include: "/**/interview_interviewers.view.lkml"
...
explore: candidate_application_funnel {
  ...
  join: interview_interviewers {
    view_label: "Interviews"
    sql_on: ${candidate_application_funnel.application_uuid} = ${interview_interviewers.application_id} ;;
    type: left_outer
    relationship: one_to_many
  }
