- dashboard: weekly_cohorts_ct_migrated_dev
  ...
  - title: Weekly Cohorts (Customer Retention)
    ...
    type: looker_grid
    fields: [crm_customer_feed.first_order_week, orders_cl.cnt_unique_customers, crm_customer_feed.weeks_time_since_sign_up]
    pivots: [crm_customer_feed.weeks_time_since_sign_up]
    fill_fields: [crm_customer_feed.first_order_week]
    filters:
    ...
    column_order: [crm_customer_feed.first_order_week, cohort_size, 0_pcnt_of_cohort_still_active,
  ...
  - title: Weekly Cohorts (Order Frequency)
    ...
    explore: orders_customers_dev
    type: looker_grid
    fields: [crm_customer_feed.first_order_week, crm_customer_feed.weeks_time_since_sign_up,
    ...
    show_row_totals: true
    series_column_widths:
      crm_customer_feed.first_order_week: 178
      pcnt_of_cohort_still_active: 193
      crm_customer_feed.cnt_unique_customers: 137
      cohort_size: 78
      order_frequency: 94
    series_cell_visualizations:
      pcnt_of_cohort_still_active:
    ...
    column_order: [crm_customer_feed.first_order_week, cohort_size, 0_order_frequency,
  ...
  - title: Weekly Cohorts (GMV)
    ...
    explore: orders_customers_dev
    type: looker_grid
    fields: [crm_customer_feed.first_order_week, orders_cl.cnt_unique_customers, orders_cl.sum_gmv_gross,
      crm_customer_feed.weeks_time_since_sign_up]
    pivots: [crm_customer_feed.weeks_time_since_sign_up]
    fill_fields: [crm_customer_feed.first_order_week]
    filters:
      orders_cl.is_internal_order: 'no'
    ...
    column_order: [crm_customer_feed.first_order_week, gmv_gross, 0_gmv_retention,
  ...
  - title: Monthly Cohorts (Revenue / GMV net of discounts)
    ...
    explore: orders_customers_dev
    type: looker_grid
    fields: [crm_customer_feed.first_order_week, orders_cl.cnt_unique_customers, orders_cl.sum_discount_amt,
      orders_cl.sum_revenue_gross, crm_customer_feed.weeks_time_since_sign_up]
    pivots: [crm_customer_feed.weeks_time_since_sign_up]
    fill_fields: [crm_customer_feed.first_order_week]
    filters:
      orders_cl.is_internal_order: 'no'
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: [crm_customer_feed.first_order_week, revenue, revenue_retention]
    show_totals: true
    show_row_totals: true
    series_column_widths:
      crm_customer_feed.first_order_week: 178
  ...
  - title: Weekly Cohorts (Customer Retention w/o Voucher Reorders)
    ...
    explore: orders_customers_dev
    type: looker_grid
    fields: [orders_cl.cnt_unique_customers, crm_customer_feed.weeks_time_since_sign_up,
      orders_cl.cnt_unique_customers_without_voucher, orders_cl.cnt_unique_customers_with_voucher,
      crm_customer_feed.first_order_week]
    pivots: [crm_customer_feed.weeks_time_since_sign_up]
    fill_fields: [crm_customer_feed.first_order_week]
    filters:
      orders_cl.is_internal_order: 'no'
    ...
    column_limit: 50
    total: true
    dynamic_fields: [{category: table_calculation, expression: 'if(${crm_customer_feed.weeks_time_since_sign_up}=0,1,${orders_cl.cnt_unique_customers_without_voucher}/pivot_index(${orders_cl.cnt_unique_customers},1))',
    ...
    show_row_totals: true
    series_column_widths:
      crm_customer_feed.first_order_week: 196
      pcnt_of_cohort_still_active: 82
      weekly_cohorts.cnt_unique_customers: 137
      cohort_size: 90
  ...
  - name: Hub Name
    ...
    explore: orders_customers_dev
    listens_to_filters: []
    field: crm_customer_feed.first_order_hub
