- dashboard: address_daily_aggregates
  title: \[WIP\] Address Daily Aggregates
  layout: newspaper
  ...
  - title: Address Selected
    ...
    type: single_value
    fields: [address_daily_aggregates.count, address_daily_aggregates.cnt_users_address_selected, address_daily_aggregates.cnt_confirmed_and_skipped_area_available,
      address_daily_aggregates.cnt_address_confirmed_area_available]
    filters: {}
    limit: 500
    column_limit: 50
    dynamic_fields: [{category: table_calculation, expression: " (${address_daily_aggregates.cnt_address_confirmed_area_available}+${address_daily_aggregates.cnt_confirmed_and_skipped_area_available})",
      ...
      {category: table_calculation, expression: 'sum(offset_list(${address_daily_aggregates.cnt_users_address_selected},7,7))/sum(offset_list(${address_daily_aggregates.count},7,7))',
    ...
    listen:
      Platform: address_daily_aggregates.device_type
      App Version: address_daily_aggregates.full_app_version
      Country: address_daily_aggregates.country
      Event Date: address_daily_aggregates.event_date_at_date
      Is New User (First Session): address_daily_aggregates.is_new_user
    row: 7
    col: 1
    width: 4
    height: 2
  - title: Waitlist Intent
    ...
    dynamic_fields: [{category: table_calculation, expression: "${address_daily_aggregates.cnt_has_waitlist_signup_selected}-\
        ...
        _type_hint: number}, {category: table_calculation, expression: 'sum(offset_list(${address_daily_aggregates.cnt_has_waitlist_signup_selected},7,7))/sum(offset_list(${address_daily_aggregates.count},7,7))',
        label: conversion last week, value_format: !!null '', value_format_name: percent_1,
        _kind_hint: measure, table_calculation: conversion_last_week, _type_hint: number,
        is_disabled: true}, {category: table_calculation, expression: "(${conversion_this_week}-${conversion_last_week})*100",
        label: conversion diff, value_format: 0.0 pp, value_format_name: !!null '',
  ...
  - title: Actions Inside Delivery Area (% Over All Sessions)
    ...
    explore: address_daily_aggregates
    type: looker_column
    fields: [address_daily_aggregates.event_date_at_date, address_daily_aggregates.count, address_daily_aggregates.cnt_users_location_pin_placed,
  ...
  - title: Actions Outside Delivery Area (% Over All Sessions)
    ...
    fields: [address_daily_aggregates.event_date_at_date, address_daily_aggregates.count, address_daily_aggregates.cnt_users_location_pin_placed,
      ...
      address_daily_aggregates.cnt_unavailable_area, address_daily_aggregates.cnt_noaction_area_unavailable,
      address_daily_aggregates.cnt_waitlist_and_browse_area_unavailable]
    fill_fields: [address_daily_aggregates.event_date_at_date]
    filters: {}
    sorts: [address_daily_aggregates.event_date_at_date desc]
    limit: 500
    ...
    defaults_version: 1
    hidden_fields: [address_daily_aggregates.count, address_daily_aggregates.cnt_users_location_pin_placed,
      inside_delivery_zone, sum_actions, address_daily_aggregates.cnt_unavailable_area, address_daily_aggregates.cnt_waitlist_area_unavailable,
      address_daily_aggregates.cnt_browse_area_unavailable, address_daily_aggregates.cnt_noaction_area_unavailable,
      address_daily_aggregates.cnt_waitlist_and_browse_area_unavailable]
    note_state: collapsed
    note_display: hover
  ...
  - title: Outside Of Delivery Area
    ...
    dynamic_fields: [{category: table_calculation, expression: "${address_daily_aggregates.cnt_unavailable_area}/${address_daily_aggregates.count}",
        ...
        _type_hint: number}, {category: table_calculation, expression: 'sum(offset_list(${address_daily_aggregates.cnt_unavailable_area},0,7))/sum(offset_list(${address_daily_aggregates.cnt_users_location_pin_placed},0,7))',
  ...
  - title: Outside Of Delivery Area (% Over All Sessions)
    ...
    fields: [address_daily_aggregates.cnt_unavailable_area, address_daily_aggregates.event_date_at_date,
      address_daily_aggregates.device_type, address_daily_aggregates.cnt_users_location_pin_placed, address_daily_aggregates.count]
    pivots: [address_daily_aggregates.device_type]
    fill_fields: [address_daily_aggregates.event_date_at_date]
    filters: {}
    sorts: [address_daily_aggregates.event_date_at_date desc, address_daily_aggregates.device_type]
    limit: 500
    column_limit: 50
    row_total: right
    dynamic_fields: [{category: table_calculation, expression: "${address_daily_aggregates.cnt_unavailable_area}/${address_daily_aggregates.count}",
        label: "% sessions unavailable area vs. location sessions", value_format: !!null '',
        value_format_name: percent_1, _kind_hint: measure, table_calculation: sessions_unavailable_area_vs_address_daily_aggregates,
        _type_hint: number}, {category: table_calculation, expression: 'sum(offset_list(${address_daily_aggregates.cnt_unavailable_area},0,7))/sum(offset_list(${address_daily_aggregates.cnt_users_location_pin_placed},0,7))',
        label: "% sessions with unavailable area last 7 days", value_format: !!null '',
        value_format_name: percent_1, _kind_hint: measure, table_calculation: sessions_with_unavailable_area_last_7_days,
        _type_hint: number, is_disabled: true}, {category: table_calculation, expression: 'sum(offset_list(${address_daily_aggregates.cnt_unavailable_area},7,7))/sum(offset_list(${address_daily_aggregates.cnt_users_location_pin_placed},7,7))',
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: android - sessions_unavailable_area_vs_address_daily_aggregates,
            id: android - sessions_unavailable_area_vs_address_daily_aggregates, name: android},
          {axisId: ios - sessions_unavailable_area_vs_address_daily_aggregates, id: ios -
              sessions_unavailable_area_vs_address_daily_aggregates, name: ios}], showLabels: false,
    ...
    series_types:
      ...
      android - sessions_unavailable_area_vs_address_daily_aggregates: line
      ios - sessions_unavailable_area_vs_address_daily_aggregates: line
    ...
    series_colors:
      ...
      ios - sessions_unavailable_area_vs_address_daily_aggregates: "#d7b9f9"
      android - sessions_unavailable_area_vs_address_daily_aggregates: "#d7b9f9"
      unavailable_area: "#B1399E"
    series_labels:
      address_daily_aggregates.count: Sessions
      sessions_with_unavailable_areas_over_overall_sessions: "% Sessions with unavailable\
        \ area"
      android - address_daily_aggregates.count: Sessions (Android)
      ios - address_daily_aggregates.count: Sessions (iOS)
      ...
      ios - sessions_with_unavailable_areas_over_overall_sessions: "% Sessions With\
        \ Unavailable Area"
      android - sessions_unavailable_area_vs_address_daily_aggregates: "% Unavailable Area\
        \ (Android)"
      ios - sessions_unavailable_area_vs_address_daily_aggregates: "% Unavailable Area (iOS)"
      unavailable_area: "% Unavailable Area (All)"
    series_point_styles:
      android - sessions_unavailable_area_vs_address_daily_aggregates: square
      ios - sessions_unavailable_area_vs_address_daily_aggregates: diamond
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
  ...
  - title: Address Unidentifiable (% Over Address Sessions)
    ...
    fields: [address_daily_aggregates.cnt_users_location_pin_placed, address_daily_aggregates.cnt_address_resolution_failed_inside_area,
      address_daily_aggregates.event_date_at_date, address_daily_aggregates.device_type, address_daily_aggregates.cnt_address_resolution_failed_outside_area]
    pivots: [address_daily_aggregates.device_type]
    fill_fields: [address_daily_aggregates.event_date_at_date]
    filters: {}
    sorts: [address_daily_aggregates.event_date_at_date desc, address_daily_aggregates.device_type]
  ...
  - title: Address Tap At Checkout (% Over Checkout Sessions)
    ...
    listen:
      ...
      Event Date: checkout_sessions.session_start_at_date
  ...
  - name: Address Selection
    ...
    body_text: |-
      <p align="center">
      (NOTE : Android sends more tracking events for unidentified address and outside of delivery area than is truly the case [<a href="https://goflink.atlassian.net/browse/POST-300">bug ticket</a>])
      </p>
    row: 11
    col: 0
    width: 24
  ...
  - title: Inside Delivery Area Funnel By New/Returning User
    ...
    explore: address_daily_aggregates
    type: looker_column
    fields: [address_daily_aggregates.count, address_daily_aggregates.cnt_users_location_pin_placed, address_daily_aggregates.cnt_available_area,
      address_daily_aggregates.cnt_address_confirmed_area_available, address_daily_aggregates.cnt_confirmed_and_skipped_area_available,
      address_daily_aggregates.is_new_user]
    fill_fields: [address_daily_aggregates.is_new_user]
    sorts: [address_daily_aggregates.is_new_user]
    limit: 500
    dynamic_fields: [{category: table_calculation, expression: "${address_daily_aggregates.cnt_address_confirmed_area_available}+${address_daily_aggregates.cnt_confirmed_and_skipped_area_available}",
    ...
    series_labels:
      address_daily_aggregates.count: Sessions Started
    ...
    show_dropoff: true
    hidden_fields: [address_daily_aggregates.cnt_address_confirmed_area_available, address_daily_aggregates.cnt_confirmed_and_skipped_area_available]
    defaults_version: 1
    y_axes: []
    note_state: collapsed
    note_display: hover
  ...
  - title: Outside Delivery Area Funnel By New/Returning User
    ...
    explore: address_daily_aggregates
    type: looker_column
    fields: [address_daily_aggregates.is_new_user, address_daily_aggregates.count, address_daily_aggregates.cnt_users_location_pin_placed,
      address_daily_aggregates.cnt_unavailable_area, address_daily_aggregates.cnt_waitlist_and_browse_area_unavailable,
    ...
    series_labels:
      address_daily_aggregates.count: Sessions Started
      address_daily_aggregates.cnt_users_location_pin_placed: Address Flow Started
      address_daily_aggregates.cnt_available_area: Sessions With Location In Available Area
      address_confirmed_total: Sessions With Address Selected
      address_daily_aggregates.cnt_unavailable_area: Address Outside Delivery Area
      waitlist_intent_total: Waitlist Signup Intent
    show_dropoff: true
    hidden_fields: [address_daily_aggregates.cnt_waitlist_and_browse_area_unavailable, address_daily_aggregates.cnt_waitlist_area_unavailable]
    defaults_version: 1
    y_axes: []
    note_state: collapsed
    note_display: hover
  ...
  - title: New Tile
    ...
    note_text: What was mCVR1 over the selected period? (= users with selected address
      / active users)
    listen:
      Is New User (First Session): daily_user_aggregates.is_new_user
    row: 4
    col: 1
    width: 8
    height: 3
  - title: 'mCVR1: Active Users With Address'
    ...
    explore: daily_user_aggregates
    type: looker_column
    fields: [daily_user_aggregates.active_users, daily_user_aggregates.device_type, daily_user_aggregates.event_date_granularity,
      daily_user_aggregates.mcvr_1]
    pivots: [daily_user_aggregates.device_type]
    filters:
      daily_user_aggregates.event_date_at_date: 30 days ago for 30 days
      daily_user_aggregates.country_iso: ''
      daily_user_aggregates.device_type: ''
      ...
      daily_user_aggregates.hub_code: ''
    sorts: [daily_user_aggregates.device_type, daily_user_aggregates.event_date_granularity]
    limit: 500
    column_limit: 50
    row_total: right
    x_axis_gridlines: false
    ...
    y_axes: [{label: !!null '', orientation: left, series: [{axisId: daily_user_aggregates.mcvr_1,
            id: android - daily_user_aggregates.mcvr_1, name: mCVR1 (Android)}, {axisId: daily_user_aggregates.mcvr_1,
            id: ios - daily_user_aggregates.mcvr_1, name: mCVR1 (iOS)}, {axisId: daily_user_aggregates.mcvr_1,
            id: Row Total - daily_user_aggregates.mcvr_1, name: mCVR1 (All)}], showLabels: true,
    ...
    series_labels:
      daily_user_aggregates.active_users: # Active Users (30 min.)
  ...
  - name: Platform
    ...
    explore: address_daily_aggregates
    listens_to_filters: []
    field: address_daily_aggregates.device_type
  - name: App Version
    title: App Version
    type: field_filter
    default_value: ''
    ...
    field: address_daily_aggregates.full_app_version
  - name: Event Date
    title: Event Date
    type: field_filter
  ...
  - name: Country
    ...
    explore: address_daily_aggregates
    listens_to_filters: []
    field: address_daily_aggregates.country
  - name: Is New User (First Session)
    ...
    explore: address_daily_aggregates
    listens_to_filters: []
    field: address_daily_aggregates.is_new_user
