- dashboard: hub_overview_migrated
  ...
  - title: Hub Performance
    ...
    fields: [orders.cnt_orders, orders.cnt_unique_orders_new_customers,
      ...
      orders.pct_delivery_in_time, hubs.hub_name, shyftplan_riders_pickers_hours.rider_utr]
    filters:
      hubs.hub_name: ''
    ...
    column_order: ["$$$_row_numbers_$$$", hubs.hub_name, orders.cnt_orders, orders.avg_order_value_gross,
      orders.avg_fulfillment_time_mm_ss, orders.pct_delivery_in_time, orders.pct_delivery_late_over_5_min,
      orders.pct_delivery_late_over_10_min, orders.sum_gmv_gross, orders.cnt_unique_customers,
      orders.cnt_unique_orders_new_customers, orders.pct_discount_order_share,
      orders.pct_discount_value_of_gross_total, shyftplan_riders_pickers_hours.rider_utr,
    ...
    series_column_widths:
      ...
      orders.cnt_unique_orders_new_customers: 108
      orders.cnt_unique_orders_existing_customers: 147
      orders.cnt_unique_customers: 96
      ...
      orders.pct_discount_value_of_gross_total: 101
      orders.avg_delivery_fee_gross: 103
      orders.avg_acceptance_time: 175
      orders.sum_gmv_gross: 91
  ...
  - title: Total Hubs
    ...
    filters:
      orders.is_internal_order: 'no'
      orders.is_successful_order: 'yes'
      orders.created_date: 14 days ago for 14 days
      hubs.live: ''
