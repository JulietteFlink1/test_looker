...
view: retail_kpis_rev_per_subcat {
  ...
  dimension: primary_key {
    primary_key: yes
    sql: concat( ${sub_category_name}, CAST(${created_date} as string) ) ;;
    hidden: yes
  }
  ...
  #   label: "per Subcategory: SUM Item Prices sold (net)"
  ...
  #   label: "per Subcategory: Sum Item Price Net Current"
  #   group_label: "Measures per Subcategory"
  #   value_format_name: eur
  #   type: sum
  # }
  # measure: sum_item_price_net_previous {
  #   label: "per Subcategory: Sum Item Price Net Previous"
  #   group_label: "Measures per Subcategory"
  #   value_format_name: eur
  #   type: sum
  # }
