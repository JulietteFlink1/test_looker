view: shyftplan_riders_pickers_hours_clean {
  ...
  measure: rider_utr {
    label: "AVG Rider UTR"
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders) / # Worked Rider Hours"
  ...
  measure: rider_rider_cap_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders) / # Worked Rider Hours (incl. Rider Captains)"
  ...
  measure: picker_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders) / # Worked Picker Hours"
  ...
  measure: hub_staff_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders)/ # Worked Hub (Inventory Associate, Picker, Rider Captains and shift Lead) Hours"
  ...
  measure: ops_associate_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders) / # Worked Ops Staff (Inventory Associate, Picker, Ops Associate and Rider Captains) Hours"
  ...
  measure: wh_ops_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders)/ # Worked Warehouse Ops Hours"
  ...
  measure: rider_captain_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders)/ # Worked Rider Captain Hours"
  ...
  measure: all_staff_utr {
    ...
    type: number
    description: "# Orders from opened hub (excl. Click & Collect and External Orders) / # Worked All Staff (incl. Rider,Picker,WH Ops, Rider Captain, Ops Associate, Shift Lead and Deputy Shift Lead) Hours"
