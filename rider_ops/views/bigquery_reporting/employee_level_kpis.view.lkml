...
view: employee_level_kpis {
  ...
  measure: sum_delivery_distance_km {
    ...
    description: "Sum of delivery distance rider drove between hub and customer dropoff (most direct path / straight line) in kilometers. For stacked orders, it is the sum of distance from previous customer."
  ...
  measure: avg_delivery_distance_km {
    ...
    description: "Average distance between hub and customer dropoff rider drove (most direct path / straight line) in kilometers. For stacked orders, it is the average distance from previous customer."
